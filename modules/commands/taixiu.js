...
module.exports.run = async function ({ api, event, args, Currencies, Users }) {
    ...
    try {
        const res = (await axios.get(`https://Ryanair-Soucre-Api.chauminhtri2022.repl.co/taixiu`)).data
        const image = [];
        ...
        console.log(e);
        return api.sendMessage('🎋Lỗi không mong muốn, Hãy liên hệ admin để fix 😉 ', threadID, messageID);
    }
}