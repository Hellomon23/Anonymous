...
if ((event.body.toLowerCase() == "vg") ||  (event.body.toLowerCase() == "vâg")) {
  ...
  if ((event.body.toLowerCase() == ":))") || (event.body.toLowerCase() == ":)))")) {
    return api.sendMessage("Cười ncc ! như vậy nè 😏😏", threadID);
  };
if ((event.body.toLowerCase() == "hả") || (event.body.toLowerCase() == "Hả")) {
    return api.sendMessage("Mày bị điếc hay gì mà hả🐸🐸", threadID);
  };
  if ((event.body.toLowerCase() == "gà") || (event.body.toLowerCase() == "Gà")) {
    return api.sendMessage("Djtme nó gà vl ae ạ🐥🐥", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Lq ko") || (event.body.toLowerCase() == "Lq hông")) {
    return api.sendMessage("Đọc id đi con gà😏 lại phải gánh", threadID);
  };

  if ((event.body.toLowerCase() == "xin out") || (event.body.toLowerCase() == "Xin out")) {
    return api.sendMessage("Ok friend 👋 Bye bạn. Mình thông báo qtv sau.", threadID);
  };

  if ((event.body.toLowerCase() == "Game") || (event.body.toLowerCase() == "game")) {
    return api.sendMessage("Nghiện game à rủ hoài🤯 Vô đi nào 🐸", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "pubg ko") || (event.body.toLowerCase() == "Pubg ko")) {
    return api.sendMessage("Vô để t chỉ bắn bot🤯 quên t là bot😱", threadID);
  };

 if ((event.body.toLowerCase() == "=))") || (event.body.toLowerCase() == "=)))")) {
    return api.sendMessage("😎Tk dbrr cười cc, nhếch mép😼", threadID);
  };

  if ((event.body.toLowerCase() == "bsvv nha mn") || (event.body.toLowerCase() == "bsvv")) {
    return api.sendMessage("Chào bạn ,chúc bạn buổi sáng tốt lành ❤️", threadID);
  };

  if ((event.body.toLowerCase() == "btvv nha mng") || (event.body.toLowerCase() == "btvv")) {
    return api.sendMessage("Chào bạn , chúc bạn một buổi tối tốt lành ❤️", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Mình xin out nha") || (event.body.toLowerCase() == "Mình xin out")) {
    return api.sendMessage("Oki bye bạn yêu🥲 Hẹn gặp lại", threadID);
  };

  if ((event.body.toLowerCase() == ":v") || (event.body.toLowerCase() == "((=")) {
    return api.sendMessage("🐸 Mày cười kiểu gì vậy, táng sml đó", threadID);
  };
