const fbname = "by.hahax";
const githubname = "hellomon23";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("NekoChan", canvas.width / 2 - 700, 1650);
    ctx.save();
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("@by.hahax", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("@hellomon23", 1600, 3150);
    ctx.fillStyle = "#000"
    ctx.fillText("@_ins.hahax", 2000, 3600);
    ctx.beginPath();
